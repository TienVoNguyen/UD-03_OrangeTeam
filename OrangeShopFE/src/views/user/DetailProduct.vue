<template>
  <el-main>
    <!-- Page Header Start -->
    <el-page-header class="m-auto" @back="goBack">
      ...
      <div class="row px-xl-5">
        ...
        <div class="col-lg-7 pb-5">
          ...
          <div class="d-flex mb-3">
            ...
            <form>
              <div class="custom-control custom-radio custom-control-inline">
                <input id="size-1" type="radio" class="custom-control-input" name="size">
                <label class="custom-control-label" for="size-1">XS</label>
              </div>
              <div class="custom-control custom-radio custom-control-inline">
                <input id="size-2" type="radio" class="custom-control-input" name="size">
                <label class="custom-control-label" for="size-2">S</label>
              </div>
              <div class="custom-control custom-radio custom-control-inline">
                <input id="size-3" type="radio" class="custom-control-input" name="size">
                <label class="custom-control-label" for="size-3">M</label>
              </div>
              <div class="custom-control custom-radio custom-control-inline">
                <input id="size-4" type="radio" class="custom-control-input" name="size">
                <label class="custom-control-label" for="size-4">L</label>
              </div>
              <div class="custom-control custom-radio custom-control-inline">
                <input id="size-5" type="radio" class="custom-control-input" name="size">
          ...
          <div class="d-flex mb-4">
            ...
            <form>
              <div class="custom-control custom-radio custom-control-inline">
                <input id="color-1" type="radio" class="custom-control-input" name="color">
                <label class="custom-control-label" for="color-1">Black</label>
              </div>
              <div class="custom-control custom-radio custom-control-inline">
                <input id="color-2" type="radio" class="custom-control-input" name="color">
                <label class="custom-control-label" for="color-2">White</label>
              </div>
              <div class="custom-control custom-radio custom-control-inline">
                <input id="color-3" type="radio" class="custom-control-input" name="color">
                <label class="custom-control-label" for="color-3">Red</label>
              </div>
              <div class="custom-control custom-radio custom-control-inline">
                <input id="color-4" type="radio" class="custom-control-input" name="color">
                <label class="custom-control-label" for="color-4">Blue</label>
              </div>
              <div class="custom-control custom-radio custom-control-inline">
                <input id="color-5" type="radio" class="custom-control-input" name="color">
          ...
          <div class="d-flex align-items-center mb-4 pt-2">
            ...
            <button class="btn btn-primary px-3"><i class="fa fa-shopping-cart mr-1" /> Add To Cart</button>
          </div>
...
<script>
import Breadcrumb from '@/views/user/component/Breadcrumb/index.vue'
...
export default {
  ...
  components: { ValidationObserver, ValidationProvider, Breadcrumb },
