<template>
  <ValidationObserver ref="observer" v-slot="{ handleSubmit }">
    <h3 slot="title" class="title mt-3"><strong>Cập nhật thông tin đơn vị quản lý</strong></h3>
      ...
      <div class="row">
        ...
        <div class="row mt-3">
          <el-table
            ...
            style="width: 100%;"
          >
            <el-table-column label="Thao tác" width="200px" align="center"><i class="el-icon-remove-outline" />
    ...
    <div class="footer">
      ...
      <router-link :to="{ path: '/creditRatingsRouter/ctck_customers/change_department'}" class="btn btn-outline-secondary me-3" style="">Đóng</router-link>
