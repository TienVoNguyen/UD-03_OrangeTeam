      ...
      >
        <el-table-column label="Thao tác" width="100px" align="center">
          <template slot-scope="{row}">
            ...
            <router-link :to="{ path: '/creditRatingsRouter/ctck_customers/update_change_department/'+row.id}" class="el-icon-edit" style="color: #083863" />
        ...
        <el-table-column label="Mã số thuế" width="130px" align="center">
          <template slot-scope="{row}">
            ...
            <router-link :to="{ path: '/creditRatingsRouter/ctck_customers/details_change_department/'+row.id}">
