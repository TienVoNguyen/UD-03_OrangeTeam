<template>
  <el-dialog
    ...
    :show-close="false"
  >
    <h3 slot="title" class="title mt-3"><strong>Xóa người phê duyệt</strong></h3>
    <div class="text-center">
      <h5 class="text-danger">Bạn có chắc muốn xóa người phê duyệt?</h5>
    </div>
    <div slot="footer" class="dialog-footer">
      <button class="btn btn-outline-secondary me-3" @click="closeDialog">Đóng</button>
      <button class="btn btn-outline-warning" @click="deleteData">Đồng ý</button>
    </div>
  </el-dialog>
</template>
